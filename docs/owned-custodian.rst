...
It may be useful to view the `OwnedCustodian.sol <https://github.com/zerolawtech/SFT-Protocol/blob/master/contracts/custodians/OwnedCustodian.sol>`__ source code for the following contracts while reading this document.
