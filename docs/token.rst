...
* `SecurityToken.sol <https://github.com/zerolawtech/SFT-Protocol/blob/master/contracts/SecurityToken.sol>`__ is used for the issuance of non-certificated (book entry) securities. These tokens are fungible.
* `NFToken.sol <https://github.com/zerolawtech/SFT-Protocol/blob/master/contracts/NFToken.sol>`__ is used for the issuance of certificated securities. These tokens are non-fungible.

Both contracts are derived from a common base `Token.sol <https://github.com/zerolawtech/SFT-Protocol/blob/master/contracts/bases/Token.sol>`__.
