...
def inside():
    '''inside'''
    token.modifyRanges(12000, 13000, 0, "0x01", {'from':a[0]})
    _check(
        [(1,10001)],
...
def start_partial_different():
    ...
    token.modifyRanges(8000, 12000, 0, "0x01", {'from': a[0]})
...
def start_partial_same():
    ...
    token.modifyRanges(1, 12000, 0, "0x01", {'from': a[0]})
...
def start_absolute():
    ...
    token.modifyRanges(1, 5000, 0, "0x01", {'from': a[0]})
...
def stop_partial_different():
    ...
    token.modifyRanges(15000, 25000, 0, "0x01", {'from': a[0]})
...
def stop_partial_same_abs():
    ...
    token.modifyRanges(15000, 30001, 0, "0x01", {'from': a[0]})
...
def stop_absolute():
    ...
    token.modifyRanges(29000, 30001, 0, "0x01", {'from': a[0]})
    token.transferRange(a[4], 20001, 29000, {'from': a[3]})
...
def whole_range_different():
    ...
    token.modifyRanges(1, 30001, 0, "0x01", {'from': a[0]})
...
def whole_range_left_abs():
    ...
    token.modifyRanges(1, 20001, 0, "0x01", {'from': a[0]})
    token.transferRange(a[1], 10001, 20001, {'from': a[2]})
    _check(
        [(1, 20001)],
        [],
...
def whole_range_right_abs():
    ...
    token.modifyRanges(10001, 30001, 0, "0x01", {'from': a[0]})
    token.transferRange(a[3], 10001, 20001, {'from': a[2]})
    _check(
        [(1, 10001)],
        [],
