...
interface IssuerModule {
	...
	function transferTokens(address _token, bytes32[2] _id, uint8[2] _class, uint16[2] _country, uint256 _value) external view returns (bool);
	function balanceChanged(address _token, bytes32 _id, uint8 _class, uint16 _country, uint256 _old, uint256 _new) external returns (bool);
	function getBindings() external view returns (bool, bool, bool);
